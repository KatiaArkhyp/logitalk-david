...
class MainWindow(CTk):
    def __init__(self):
        ...
        self.message_input = CTkEntry(self,placeholder_text="print you message")
    ...
    def adaptive_ui(self):
        ...
        self.message_input.place(x=self.frame.winfo_width(),y = self.winfo_height()-self.send_button.winfo_width())
