...
class AuthWindow(CTk):
    def __init__(self):
        ...
        img_ctk = CTkImage(light_image=Image.open('../setting.png'), size=(450, 400))
        ...
        self.name_entry = CTkEntry(self.right_frame, placeholder_text='ім`я',
                                   height=45, font=main_font,corner_radius=25, fg_color='#eae6ff'
                                    )
        ...
        self.settings_button = CTkButton(self.right_frame, text='Налаштування', height=45,
                                         corner_radius=25, fg_color='#eae6ff', font=main_font, text_color='#6753cc',
                                         image=img_ctk, compound='left')
